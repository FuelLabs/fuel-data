...
pub use fuel_core_types::{
    blockchain::{
        ...
        consensus::{
            poa::PoAConsensus as FuelCorePoAConsensus, Consensus as FuelCoreConsensus,
    ...
    services::{
        block_importer::{
            ImportResult as FuelCoreImportResult, SharedImportResult as FuelCoreSharedImportResult,
        },
